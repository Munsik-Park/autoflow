...
citation of a host record; the `inherited_verdicts` key that once carried such citations is retired
with the Green-tree register (ADR-0024 D6) and is not written.
