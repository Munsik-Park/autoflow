...
- **Writes artifacts** to `.autoflow/issue-{N}-*.md` through the scribe, after the discussion: the feature design, the verification design and the deliberation report. It does not inline artifact bodies in its return.
