...
1. **Where a content change is raised.** Besides the orchestrator's routing of the ARCHITECT report
   ...
   in its report, and a gate recommendation reaches the operator through the orchestrator's
   `operator` disposition. The heading names the phase the change surfaced in:
