...
공통 접두어를 대괄호로 묶고, 나머지 설명은 자유롭게 기술한다.
...
| `#N` | GitHub 이슈 번호. **이슈 제목에는 생략 가능**; **PR 제목에는 필수** |
| 자유 설명 | 길이·언어 제한 없음 |
...
[feat · #224]             Enterprise 멤버 활동 감사 로그
[fix  · #200]             YouTube 자막 취득 실패
[chore · #43]             PAT rotation 문서화
```
