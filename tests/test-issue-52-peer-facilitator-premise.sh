...
ALLOWLIST_52=(
  ...
  # the blocks above (precedent: 334adc3 for #69; ledger E21 class). #71
  # removes the cycle-digest emitter and the cross-issue recurrence scan;
  # every path its diff touches is admitted here, including the sibling
  # guards amended for the same reason.
