...
if [[ -z "$BASE_REF" ]]; then
  ...
  allow_list=(
    ...
    # tests/test-issue-846-doc-assertions.sh and tests/fixtures/doc-invariants.json
    ...
    # tests/test-issue-27/59/62/798/799/846/848/955-*.sh are already admitted above.
