...
| GATE:HYPOTHESIS → ARCHITECT | cause analysis PASS + code change required + its recommendations disposed (a `fix` item enters the ARCHITECT `init` brief) |
