...
| VALIDATE → RED | step-1 whole-tree sweep (`run-suites.sh --all`, unconditional — the cycle's coverage floor) fails → fix tests/implementation and re-flow, exactly as INTEGRATE FAIL does |
